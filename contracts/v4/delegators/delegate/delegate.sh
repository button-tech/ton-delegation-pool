...
printf "\n\nEnter the amount to delegate: " && read -r amount

/usr/local/bin/ton/liteclient-build/crypto/fift -I /usr/local/bin/ton/lite-client/crypto/fift/lib/ -s delegate-req.fif $wallet_path ../../bin/msg-body
sleep 1
